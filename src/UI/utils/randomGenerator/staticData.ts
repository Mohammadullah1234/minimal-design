...
export type ColumnDataGenerator<Value> = (
  data: any,
...
export const TAXCODE_OPTIONS: string[] = [
  "BR",
  "1250L",
  "20G",
  "BC45",
...
export const RATE_TYPE_OPTIONS: string[] = ["Fixed", "Floating"];
export const CONTRACT_TYPE_OPTIONS: string[] = ["FP", "TM", "CR"];
...
export const COMMODITY_OPTIONS: string[] = [
  "Corn",
  "Oats",
  "Rough Rice",
  "Soybeans",
...
export const COUNTRY_ISO_OPTIONS_SORTED: CountryIsoOption[] = [
  ...COUNTRY_ISO_OPTIONS,
